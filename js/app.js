...
app.factory("CodeSrv",function(){
    ...
    var countryCodes = [
      ...
      { name:"ساموآ آمریکا ۰۰۱ ۶۸۴", eng: "American Samoa 001 684"},
      { name:"آندورا ۰۰۳۷۶", eng: "Andorra 00376"},
      { name:"آنگولا ۰۰۲۴۴", eng: "Angola 00244"},
      { name:"آنگویلا ۰۰۱ ۲۶۴", eng: "Anguilla 001 264"},
      { name:"قطب جنوب ۰۰۶۷۲", eng: "Antarctica 00672"},
      { name:"آنتیگوا و باربودا ۰۰۱ ۲۶۸", eng: "Antigua and Barbuda 001 268"},
      ...
      { name:"باهاما ۰۰۱ ۲۴۲", eng: "Bahamas 001 242"},
      { name:"بحرین ۰۰۹۷۳", eng: "Bahrain 00973"},
      { name:"بنگلادش ۰۰۸۸۰", eng: "Bangladesh 00880"},
      { name:"باربادوس ۰۰۱ ۲۴۶", eng: "Barbados 001 246"},
      ...
      { name:"برمودا ۰۰۱ ۴۴۱", eng: "Bermuda 001 441"},
      ...
      { name:"جزایر ویرجین بریتانیا ۰۰۱ ۲۸۴", eng: "British Virgin Islands 001 284"},
      ...
      { name:"جزایر کیمن ۰۰۱ ۳۴۵", eng: "Cayman Islands 001 345"},
      ...
      { name:"دومینیکا ۰۰۱ ۷۶۷", eng: "Dominica 001 767"},
      { name:"جمهوری دومینیکن ۰۰۱ ۸۰۹", eng: "Dominican Republic 001 809"},
      ...
      { name:"گرانادا ۰۰۱ ۴۷۳", eng: "Grenada 001 473"},
      { name:"گوام ۰۰۱ ۶۷۱", eng: "Guam 001 671"},
      ...
      { name:"جامايیکا ۰۰۱ ۸۷۶", eng: "Jamaica 001 876"},
      ...
      { name:"مونتسرات ۰۰۱ ۶۶۴", eng: "Montserrat 001 664"},
      ...
      { name:"جزایر ماریانای شمالی ۰۰۱ ۶۷۰", eng: "Northern Mariana Islands 001 670"},
      ...
      { name:"سنت کیتس و نویس ۰۰۱ ۸۶۹", eng: "Saint Kitts and Nevis 001 869"},
      { name:"سنت لوسیا ۰۰۱ ۷۵۸", eng: "Saint Lucia 0Saint Martin01 758"},
      { name:"سنت مارتین ۰۰۱ ۵۹۹", eng: " 001 599"},
      ...
      { name:"ترینیداد و توباگو ۰۰۱ ۸۶۸", eng: "Trinidad and Tobago 001 868"},
      { name:"تونس ۰۰۲۱۶", eng: "Tunisia 00216"},
      { name:"ترکیه ۰۰۹۰", eng: "Turkey 0090"},
      { name:"ترکمنستان ۰۰۹۹۳", eng: "Turkmenistan 00993"},
      { name:"جزایر ترکس و کیاکوس ۰۰۱ ۶۴۹", eng: "Turks and Caicos Islands 001 649"},
      ...
      { name:"جزایر ویرجین ایالات متحده ۰۰۱ ۳۴۰", eng: "US Virgin Islands 001 340"},
